...
import { listMessages, sendMessage, stream, getUnreadCount, markRead, uploadFile, listAttachments } from '../controllers/chatController';
...
chatRouter.get('/attachments', listAttachments);
